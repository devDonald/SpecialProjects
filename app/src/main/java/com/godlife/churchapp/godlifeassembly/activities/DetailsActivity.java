...
import com.godlife.churchapp.godlifeassembly.adapter.CommentAdapter;
...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private static String GOOGLE_YOUTUBE_API = "AIzaSyC7EKpGRTsdJsVQ2SOlMN3WpCpR_rEKtOE";//here you should use your api key for testing purpose you can use this api also
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(DetailsActivity.this)
                .setStyle(KProgressHUD.Style.SPIN_INDETERMINATE)
                .setLabel("Please wait")
                .setDetailsLabel("Downloading File...")
                .setCancellable(true)
                .setAnimationSpeed(2)
                .setDimAmount(0.5f)
