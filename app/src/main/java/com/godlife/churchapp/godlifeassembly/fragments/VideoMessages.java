 ...
 */
public class VideoMessages extends Fragment {

    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyC7EKpGRTsdJsVQ2SOlMN3WpCpR_rEKtOE";//here you should use your api key for testing purpose you can use this api also
    private static String CHANNEL_ID = "UCXTMFK4-CSliIT1tXuRXpkg"; //here you should use your channel id for testing purpose you can use this ID also
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_video_messages, container, false);
